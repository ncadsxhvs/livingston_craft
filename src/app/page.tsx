...
import { PhotoGallery } from "@frontend/components/sections/photo-gallery";
import { ProductShowcase } from "@frontend/components/sections/product-showcase";
import { SectionLoading } from "@frontend/components/common/section-loading";
import { products } from "@frontend/lib/data/products";

// Lazy load below-fold sections (loaded when scrolled into view)
const FeatureHighlights = dynamic(() => import("@frontend/components/sections/feature-highlights").then(mod => ({ default: mod.FeatureHighlights })), {
  loading: () => <SectionLoading />
});

const ComparisonTable = dynamic(() => import("@frontend/components/sections/comparison-table").then(mod => ({ default: mod.ComparisonTable })), {
  loading: () => <SectionLoading />
});

const HowItWorks = dynamic(() => import("@frontend/components/sections/how-it-works").then(mod => ({ default: mod.HowItWorks })), {
  loading: () => <SectionLoading />
});

// Lazy load modal (only loads when opened)
const SampleRequestModal = dynamic(() => import("@frontend/components/modals/sample-request-modal").then(mod => ({ default: mod.SampleRequestModal })), {
  ssr: false
});
